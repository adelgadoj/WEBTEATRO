...
<body>
    ...
    $result = mysqli_query($db, "SELECT evento.id_evento, evento.titulo, evento.fecha, evento.hora, evento.costo, evento.id_sala, obra.genero, obra.id_director,obra.sinopsis,obra.ruta_img, obra.nombre_img 
FROM obra,evento WHERE obra.id_evento = evento.id_evento;");
