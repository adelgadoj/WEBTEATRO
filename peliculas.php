...
<body>
    ...
    <?php
    $db = mysqli_connect("localhost:3307", "user_1", "123456", "teatro");
    // Consultar todas las imágenes de la base de datos
    $result = mysqli_query($db, "SELECT evento.id_evento, evento.titulo, evento.fecha, evento.hora, evento.costo, evento.id_sala, pelicula.genero,pelicula.a_estreno,pelicula.duracion, pelicula.n_director,pelicula.sinopsis,pelicula.ruta_img, pelicula.nombre_img 
FROM pelicula,evento WHERE pelicula.id_evento = evento.id_evento");
